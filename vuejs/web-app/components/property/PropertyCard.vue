    ...
    <q-card>
            ...
            <div class="col col-12 col-md-8 p-4 md:pt-8 q-gutter-y-sm">
                ...
                >
                    ...
                    <div class="col col-auto">
                        ...
                        }}<q-icon name="bathtub"></q-icon>
                    </div>
                    <div class="col col-auto">
                        <q-icon name="circle" size="5px"></q-icon>
                    </div>
                    <div class="col col-auto">
                        {{ item.details.square_feet }} sqft
                    </div>
                    <div class="col col-auto">
                        <q-icon name="circle" size="5px"></q-icon>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col col-auto">
                        ...
                        {{ getDateDifferenceLabel(item.updated_at) }}
                    </div>
                </div>
            </div>
        </div>
        ...
        <q-card-section>
            <div class="row q-gutter-sm">
                <div class="col col-12 col-md align-self-center">
                    Listed by
